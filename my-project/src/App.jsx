  ...
  return (
    <main className="w-scren h-screen flex justify-center items-center">
      <div className="h-2/3 w-3/5 flex justify-center items-center xs:max-lg:scale-90 xs:max-sm:w-full lg:scale-90">
        <div className={`h-full w-1/2 xs:max-lg:h-2/3  xs:max-lg:w-4/5 bg-dark-blue rounded-3xl p-10 xs:p-5 sm:p-6 md:p-8 flex flex-col items-${!submitted ? "start" : "center"} lg:max-2xl:gap-3 lg:max-2xl:mt-4 xs:gap-2 sm:gap-3 md-gap-4`}>
          {
            !submitted ? (
              <>
                ...
                <h1 className="text-white lg:max-2xl:pt-4 xs:pt-0 sm:pt-0 md:pt-3 font-bold text-3xl">How do we do?</h1>
            ...
            (
              <div className="xs:scale-75 lg:max-2xl:scale-100 flex items-center flex-col justify-self-center">
              <img src={thankYou} alt="an illustration image" />
              <div className="my-4 py-1 px-4 rounded-2xl bg-medium-grey bg-opacity-20 text-orange">You selected 4 out of 5</div>
              <h1 className="text-white lg:max-2xl:pt-4 xs:pt-0 sm:pt-0 md:pt-3 font-bold text-3xl">Thank you!</h1>
              <p  className="text-light-grey text-center">We appreciate you taking the time to give a rating. If you ever need more support, don't hesitate to get in touch!</p>
              </div>
            )
          }
        </div>
